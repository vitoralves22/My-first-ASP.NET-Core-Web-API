...
namespace MyWallWebAPI.Infrastructure.Data.Repositories
{
    public class ChatRepository
    {
        ...
        public async Task<bool> DeleteChatUserAsync(string ApplicationUserId, int ChatId)
        {
            var item = await _context.ChatUser.FirstOrDefaultAsync(p => p.ApplicationUserId == ApplicationUserId && p.ChatId == ChatId);
           
            _context.ChatUser.Remove(item);
