...
namespace MyWallWebAPI.Migrations
{
    ...
    [Migration("20220512141459_messagereceivers")]
    partial class messagereceivers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWallWebAPI.Domain.Models.Chat", b =>
                {
                    ...
                    b.Property<string>("IniciatorId")
                        .HasColumnType("varchar(255)");

                    b.HasKey("Id");

                    b.HasIndex("IniciatorId");
            ...
            modelBuilder.Entity("MyWallWebAPI.Domain.Models.Chat", b =>
                {
                    b.HasOne("MyWallWebAPI.Domain.Models.ApplicationUser", "Iniciator")
                        .WithMany()
                        .HasForeignKey("IniciatorId");

                    b.Navigation("Iniciator");
                });
